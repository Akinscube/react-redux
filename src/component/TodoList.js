...
export const TodoList = ({ setInput, myRef, setEditTodo }) => {
  ...
  return (
    <div className="d-grid gap-3">
      <div className="d-grid gap-2 d-md-block">
        <button onClick={handleFilterDone} className="btn btn-sm me-3 d-inline btn-primary">Filter Done</button>
        <button onClick={handleFilterUndone} className="btn btn-sm me-3 d-inline btn-primary">Filter Undone</button>
